...
• Inlet height H = 0.50 m, inlet width W = 0.25 m
...
Using the Handbook formula for the 50\% cut-diameter:
dpc = $\surd$(9$\mu$HW / [2 $\cdot$ Ne $\cdot$ Vi $\cdot$ ($\rho$p $-$ $\rho$g)])

The diameter dpc of the particle collected with 50\% efficiency is most nearly:\par\vspace{3pt}
{\small\color{soft}Relevant:}\ $d_{pc} = \sqrt{\dfrac{9\,\mu\,H\,W}{2\,N_e\,V_i\,(\rho_p - \rho_g)}}$\par\vspace{3pt}
\optline{A}{7.0 $\mu$m}
\optline{B}{\correct{8.8 $\mu$m}}
\optline{C}{12.4 $\mu$m}
\optline{D}{17.5 $\mu$m}
\par\vspace{3pt}
\vspace{2pt}\par\noindent\colorbox{boxbg}{\parbox{\dimexpr\linewidth-2\fboxsep\relax}{%
\vspace{2pt}\textbf{Answer:} (B)\par\vspace{2pt}
{\small \[d_{pc} = \sqrt{\frac{9\times1.8\times10^{-5}\times0.50\times0.25}{2\times5.5\times15\times(1600-1.2)}}\]

Numerator: $9\times1.8\times10^{-5}\times0.50\times0.25 = 2.025\times10^{-5}$

Denominator: $2\times5.5\times15\times1598.8 = 263{,}802$

\[d_{pc} = \sqrt{\frac{2.025\times10^{-5}}{263{,}802}} = \sqrt{7.677\times10^{-11}} = 8.77\times10^{-6}\text{ m} \approx 8.8\;\mu\text{m}\]

Option (A) 7.0 $\mu$m: uses $\pi$ instead of 2 in the denominator ($\pi$$\times$Ne$\times$Vi). Option (C) 12.4 $\mu$m: omits H from the numerator --- uses only 9$\mu$W (missing inlet-height factor). Option (D) 17.5 $\mu$m: omits W from the numerator --- uses only 9$\mu$H. Both H (inlet height) and W (inlet width) appear in the numerator because the particle must travel across the full inlet cross-section during the Ne turns.}\par\vspace{2pt}
{\footnotesize\color{soft}Handbook: Environmental Engineering --- Cyclone 50\% Collection Efficiency for Particle Diameter: dpc = $\surd$(9$\mu$HW/[2NeVi($\rho$p$-$$\rho$g)]) (p.323) \textbullet\ Handbook p.323 --- Environmental Engineering: Cyclone 50\% Collection Efficiency for Particle Diameter}\vspace{2pt}
}}
\vspace{9pt}
\filbreak
